...
go_down(){
	# disable touchscreen
	echo 1 > `ls /sys/devices/platform/soc/1c2ac00.i2c/i2c-0/0-005d/input/input*/inhibited` &
	# turn off backlight and screen
	echo 4 > /sys/class/backlight/backlight/bl_power &
	echo 4 > /sys/devices/platform/display-engine/graphics/fb0/blank &
...
bring_up(){
	# enable touchscreen
	echo 0 > `ls /sys/devices/platform/soc/1c2ac00.i2c/i2c-0/0-005d/input/input*/inhibited` &
...
CURRENT_STATUS=`cat /sys/devices/platform/soc/1c2ac00.i2c/i2c-0/0-005d/input/input*/inhibited`
