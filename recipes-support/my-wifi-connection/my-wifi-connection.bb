...
do_install(){
  ...
  install -m 0644 ${WORKDIR}/git/wifi/wifi-old/settings ${D}/var/lib/connman/wifi_${WIFI_ID}_53617276617269_managed_psk/
  install -m 0644 ${WORKDIR}/git/wifi/wifi-old/data ${D}/var/lib/connman/wifi_${WIFI_ID}_53617276617269_managed_psk/
...
do_install:pppro(){
  ...
  install -m 0644 ${WORKDIR}/git/wifi/wifi5/settings ${D}/var/lib/connman/wifi_${WIFI_ID}_5361727661726935_managed_psk/
  install -m 0644 ${WORKDIR}/git/wifi/wifi5/data ${D}/var/lib/connman/wifi_${WIFI_ID}_5361727661726935_managed_psk/
