...
do_install:append(){
    install -D -m 0444 ${UNPACKDIR}/main.conf ${D}${sysconfdir}/connman/main.conf
    install -D -m 0644 ${UNPACKDIR}/connman_sway.conf ${D}${sysconfdir}/dbus-1/system.d/connman_sway.conf
}
